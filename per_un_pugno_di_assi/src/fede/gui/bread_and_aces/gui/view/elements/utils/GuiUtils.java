package bread_and_aces.gui.view.elements.utils;
...
public enum GuiUtils {
	...
	private GuiUtils() {
		...
		rectangles.put(EnumRectangle.name, 		new Rectangle(0, 135, 180, 50));
		rectangles.put(EnumRectangle.score, 	new Rectangle(10, 200, 50, 50));
		rectangles.put(EnumRectangle.coins, 	new Rectangle(65, 200, 50, 50));
		...
		rectangles.put(EnumRectangle.okOuter, 	new Rectangle(100, 320, 50, 70));
		rectangles.put(EnumRectangle.fold, 		new Rectangle(100, 400, 50, 50));
		rectangles.put(EnumRectangle.foldOuter,	new Rectangle(100, 400, 50, 70));
